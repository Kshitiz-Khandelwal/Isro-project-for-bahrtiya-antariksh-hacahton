...
def get_simulated_telemetry(scenario_name: str, step: int) -> tuple[list[dict], list[dict]]:
    ...
    base_t = [
        # PE-1 Interface eth2 (Branch 1)
        {
            ...
            "overlay_tunnel_loss_pct": 0.0, "overlay_tunnel_jitter_ms": 2.0,
            "overlay_tunnel_uptime_sec": 3600 + step*30, "overlay_ipsec_rekey_failures": 0,
            "utilization_rate_of_change": 0.0, "utilization_5min_ema": 32.5, "error_ratio": 0.0,
        ...
        # PE-1 Interface eth3 (Branch 2)
        {
            ...
            "underlay_if_discards_rate": 0.0, "underlay_if_errors_rate": 0.0,
            "overlay_tunnel_loss_pct": 0.0, "overlay_tunnel_jitter_ms": 1.8,
            "overlay_tunnel_uptime_sec": 3600 + step*30, "overlay_ipsec_rekey_failures": 0,
            "utilization_rate_of_change": 0.0, "utilization_5min_ema": 28.0, "error_ratio": 0.0,
            "bytes_asymmetry_ratio": 0.5, "voice_traffic_dscp_ratio": 0.20
        }
    ]
    syslogs = []
